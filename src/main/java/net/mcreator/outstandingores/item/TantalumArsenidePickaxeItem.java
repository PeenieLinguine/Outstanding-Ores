...
public class TantalumArsenidePickaxeItem extends PickaxeItem {
	public TantalumArsenidePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 3256;
			}
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		TantalumArsenideToolEffectProcedure.execute(world, x, y, z, entity);
		return retval;
	}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		TantalumArsenideWeaponEffectProcedure.execute(world, x, y, z, entity);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7c\u00A7lExplosive"));
		list.add(Component.literal("\u00A77While destroying a block, hold \u00A7r\u00A7d\u00A7nShift\u00A77 key to trigger."));
	}
}
