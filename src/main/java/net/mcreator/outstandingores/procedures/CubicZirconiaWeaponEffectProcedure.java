...
public class CubicZirconiaWeaponEffectProcedure {
	public static void execute(Entity entity) {
		...
		double j = 0;
		double k = 0;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == OutstandingOresModItems.CUBIC_ZIRCONIA_SWORD
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == OutstandingOresModItems.CUBIC_ZIRCONIA_AXE) {
